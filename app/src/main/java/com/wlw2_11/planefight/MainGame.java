...
public class MainGame extends View implements Runnable{
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawRect(80,Screen_h-100,80+plane.life*50,Screen_h-50,paint);
        //显示BOSS生命值
        paint.setColor(Color.RED);
        paint.setTextSize(40);
        canvas.drawText("BH:",0,Screen_h-100,paint);
        canvas.drawRect(80,Screen_h-150,80+boss.life*50,Screen_h-100,paint);
        //画己方飞机
        ...
        if(isLose){
            ...
            canvas.drawText("Game Over",350,800,paint);
        ...
        if(isWin){
            ...
            canvas.drawText("最终得分:"+numOfDestroy,350,900,paint);
        }
